 ...
 function menu_icon_clicked(){
   ...
   bar3.style.transform = menu_con.style.display === "flex" ? "rotate(45deg)" : "rotate(0deg)";
    ...
    return (
        <nav>
            <div id="nav_con">
              <h1 id="logo" onClick={()=>navigate("/")}>CruisElite</h1>
            ...
            <div className="menu_con" >
                ...
                <details>
                    ...
                    <h4 onClick={()=>navigate("/")}>GYM</h4>
                    <h4 onClick={()=>navigate("/food")}>ORDER FOOD</h4>
                    <h4 onClick={()=>navigate("/")}>THEATER</h4>
                    <h4 onClick={()=>navigate("/")}>BEAUTY SALOON</h4>
                </details>
                <h4 onClick={()=>navigate("/")}>CONTACT</h4>
                <h4 onClick={()=>navigate("/")}>MY ORDER</h4>
